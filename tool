...
昨天把 Raycast 卸了，换成 Tinycast
今天又把 Warp 卸了，换成 Otty：开源免费，小巧又快
Warp 其实不差，今年也开源了。但它确实越来越“重”。作为一个 terminal，它总想往 agent 方向走，可 agent 应用现在已经够成熟了，terminal 还是做回 terminal 更合适。
Otty 刚好相反，不到 100M，轻量干净，和 code agent 搭配也很顺。