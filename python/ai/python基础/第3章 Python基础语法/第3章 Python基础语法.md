...
<img src="images/image-20251205204053679.png" alt="image-20251205204053679" style="zoom:80%;" />
...
- 大驼峰命名法（upper camel case）：每个单词首字母大写，例如UpperCamelCase。一般用于类、异常、类型变量的命名。

- 小驼峰命名法（lower camel case）：第一个单词首字母小写, 之后每个单词首字母大写，例如lowerCamelCase比较少。

- 蛇形命名法（snake case）：单词间用下划线连接，
  - 全小写：例如snake_case。最常见，一般用于变量、函数、包、模块等的命名。
  - 全大写：例如AGE_MAX_VALUE。一般用于常量命名。
...
![image-20251211111904225](images/image-20251211111904225.png)

### 3.6.4 小数float和Decimal

Python将所有带小数点的数称为浮点数。Python也支持使用科学计数法表示浮点数。

要注意在使用浮点数进行计算时可能会存在微小误差。如果对计算精度要求比较高，可以使用decimal.Decimal类型。
...
![image-20260227150448407](images/image-20260227150448407.png)
...
![image-20260202143407373](images/image-20260202143407373.png)

（2）二进制：0、1，满2进1。

![image-20260202143811615](images/image-20260202143811615.png)
...
![image-20260130174725622](images/image-20260130174725622.png)
...
<img src="images/image-20251211181304169.png" alt="image-20251211181304169" style="zoom: 50%;" />
...
<img src="images/image-20251211181434848.png" alt="image-20251211181434848" style="zoom:50%;" />
...
<img src="images/image-20251211183531835.png" alt="image-20251211183531835" style="zoom:50%;" />

- 十六进制转换成二进制：将十六进制数每1位，转成对应的4位的一个二进制数即可。

- 八进制转换为二进制：将八进制数每1位，转成对应的3位的一个二进制数即可。

![image-20251211183742409](images/image-20251211183742409.png)
...
![image-20251211184312536](images/image-20251211184312536.png)
...
![image-20251211185047188](images/image-20251211185047188.png)

![image-20251212194153929](images/image-20251212194153929.png)

![image-20251212194248823](images/image-20251212194248823.png)
...
![image-20251212205203839](images/image-20251212205203839.png)
