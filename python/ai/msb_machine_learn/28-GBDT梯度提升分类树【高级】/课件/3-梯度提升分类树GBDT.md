...
* 物理学，热力学第二定律（熵），描述的是封闭系统的混乱程度
  ...
  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/9b684b40081c4167ad956bfb0df12578.gif)
* 信息熵，和物理学中熵类似的

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/3235a432a9834dffbf1329529b9a3ac7.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/3121f5d42650420884d5cea8b0d3500d.jpg)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/f80477aa53354952a72a50b3e8cfa3c8.jpg)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/a9e7b4e2d44341708a00802af1da5bbb.jpg)
...
* 概率计算（sigmoid函数）
  ...
  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/43f5c78ea80a450bbf36bdadc8a360c6.png)
* 函数初始值（这个函数即是sigmoid分母中的 F(x)，用于计算概率）

  逻辑回归中的函数是线性函数，GBDT 中的函数**不是**线性函数，但是作用类似！

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/858cdbb8e5884b25bcc3731744b68ed9.png)
* 计算残差公式

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/e97a61426299441fa07e54e4f623cb40.png)
* 均方误差（根据均方误差，筛选最佳裂分条件）

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/a36b953577c141278b504e418c3eba6c.png)
* 决策树叶节点预测值（相当于负梯度）

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/48a8752693bf474b98d3703fba20ccb3.png)
* 梯度提升

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/a544a997a58541eb9b0b9aa6e3cf1f56.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/cf2cd7daa81741e4bd36884d1ca3adac.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/eebb20e362664aa3b8734b55ffbc1ba7.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/f2c32f16d47141359393724ae2f7e11d.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/95b5d1f5b6814f0f9f3c99278cef7f93.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/fb7e7c73ca344bf9a54c735d1c37b91f.png)
...
现在我们知道了，分裂条件是：X[0] &#x3c;= 8.5！然后计算决策树叶节点预测值（相当于负梯度），其中的 $\widetilde {y}_i$ 就是残差residual0

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/80c175975ae541ec98aa7d5bc5b07ba7.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/a425c4d9ee2d44bcb1216eb64eeba109.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/a2a0bb5de1144c7d8274b3e4ec7a6e9d.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/5b1633cbc8d94ec183c253f934d44b2c.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/c0e69a79f56f4084a91099b43c7e5ef8.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/2751b5d0b92843faa56400aaafe2a34c.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/f0ea87f061a04de692b7cdeedfcaf456.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/7375f0a51e5c4be0bc7a80ec37027b90.png)
...
* 定义交叉熵为函数$\psi(y,F(x))$
* #x3c;$\psi(y,F(x)) = -yln(p) - (1-y)ln(1-p)$
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/05cf1b889e0f4a1b905876994c83dc8a.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/0811b900c7244f709c22929595b4ce32.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/4c5929e48bc0477586d41aaad671ccf3.png)

* 求倒数

  ![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/4f25a9d4bcec4968aae72a0da9591424.png)

##### 4.4.4、将1变换到分子上

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/24f40ed192224f4188ea0a10a809ea07.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/1405015c805f4d91b04b47da3b55d019.png)

#### 4.5、决策树叶节点 $\gamma_{mj}$ 预测值

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/f9ada505c74247809065eef496865391.png)

##### 4.5.1、定义损失函数

在第m轮的学习中，决策树的第j个叶子节点预测值 $\gamma_{mj}$ 计算的公式推导:

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/2ce77389bc3e45278d07bf5980e32173.png)

定义损失函数$L(\gamma_{mj,R_{mj}})$

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/7b668176be054d75aa168754e9a5789f.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/396be5771c8c4f3fb1102041ff986750.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/ae4eb04097484a7da02ae5bc7518793e.png)

##### 4.5.5、公式合并化简

将一阶导数和二阶导数带入上式：

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/84f38a69eb794e68a247b3ba2bce2771.png)

方程移动变形：

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/16c772d5435a4f2fbce92c0c6438d7a6.png)

除法运算：

![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/af5e493e40e844129a1ddc28c4bc9312.png)
...
![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/463/1653985635078/db3c582d8e4b442a95a62b518b8e279d.png)
